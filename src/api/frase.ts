...
const QUOTES_ES = [
  ...
  "Lo que haces hoy, te acerca a quien quieres ser mañana.",
  "Un día a la vez, pero con intención.",
  "Tu cuerpo escucha lo que tu mente repite.",
  "No se trata de velocidad, se trata de dirección.",
  "El progreso es progreso, aunque sea pequeño.",
  "Sé fiel a tus hábitos, no a tus emociones.",
  "Hazlo incluso cuando no tengas ganas.",
  "Tu esfuerzo se acumula, nunca se pierde.",
  "Construye hábitos, no esperes motivación.",
  "Tu salud es tu mayor inversión.",
  "Comienza donde estás, usa lo que tienes.",
  "El autocontrol también es amor propio.",
  "Tu disciplina escribe tu futuro.",
  "Cada día es una oportunidad para mejorar.",
  "El cambio inicia con una sola decisión.",
  "Cuida tu cuerpo, es tu hogar permanente.",
  "Los hábitos saludables también se aprenden.",
  "No busques perfección, busca progreso.",
  "Tu constancia es tu superpoder.",
  "Lo difícil también es temporal.",
  "Cada elección cuenta, no la subestimes.",
  "Ser constante te lleva más lejos que ser perfecto.",
  "Un paso más es mejor que ningún paso.",
  "Hazlo por ti, no por los demás.",
  "Tu bienestar merece tu compromiso.",
  "Nada cambia si tú no cambias.",
  "Avanzas incluso cuando no lo notas.",
  ...
  "El primer paso es decidir mejorar.",
  "No retrocedas, reajusta.",
  "Tu meta no requiere prisa, solo constancia.",
  "Si no empiezas hoy, mañana será igual.",
  "Haz de tu salud una prioridad.",
  "Comprométete contigo mismo.",
  "Un hábito construido es una batalla ganada.",
  "Hoy también cuenta, no lo desperdicies.",
  "Tu versión disciplinada te está esperando.",
  "Si fuera fácil, todos lo lograrían.",
  "Lo que te cuesta hoy te fortalece mañana.",
  "Cada día suma o resta, tú decides.",
  "No te rindas antes de ver los resultados.",
  "Tarde o temprano, la constancia vence.",
  "Tu futuro yo está orgulloso de ti.",
  "Mejor poco constante que mucho esporádico.",
  "Eres capaz de más de lo que crees.",
  "Hazlo sencillo, pero hazlo.",
  "Hoy también es un buen día para avanzar."
];
